...
export interface ButtonProps
  ...
  asChild?: boolean
  /** Mostra um spinner com movimento antes do conteúdo e desabilita o botão — evita cada tela reimplementar seu próprio "disabled + texto trocado" sem nenhuma animação visível. */
  loading?: boolean
}
